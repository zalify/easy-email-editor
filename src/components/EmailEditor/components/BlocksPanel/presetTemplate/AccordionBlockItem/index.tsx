...
const list = [
  {
    thumbnail: 'https://assets.maocanhua.cn/65360c06-1efd-4ffe-9fcf-c8d574ba47b1-image.png',
    payload: {
      'type': 'accordion',
      'data': {
        'value': {
      ...
      'attributes': {
        ...
        'icon-align': 'middle',
        'icon-position': 'right',
        'icon-unwrapped-url': 'https://assets.maocanhua.cn/81f1fdfb-fbe2-4c14-94c8-d9d0d04a97f3-image.png',
        'icon-wrapped-url': 'https://assets.maocanhua.cn/9328a9b9-7ed5-493b-ba75-f72d2966ace6-image.png',
