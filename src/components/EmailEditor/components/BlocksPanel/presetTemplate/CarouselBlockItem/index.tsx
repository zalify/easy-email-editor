...
const list = [
  {
    thumbnail: 'https://assets.maocanhua.cn/2ad78cfb-dbe4-445b-9c8f-8044a945af48-image.png',
    payload: {
      'type': 'carousel',
      'data': {
        'value': {
      ...
      'attributes': {
        'align': 'center',
        'left-icon': 'https://assets.maocanhua.cn/45d7301a-db10-48e8-a679-4ba6f9c1dd85-image.png',
        'right-icon': 'https://assets.maocanhua.cn/38e38923-490f-476d-be70-ff85d345f82e-image.png',
        'icon-width': '44px',
        'thumbnails': 'visible'
      },
      'children': []
